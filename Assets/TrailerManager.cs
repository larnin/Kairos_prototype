...
public class TrailerManager : MonoBehaviour {
	...
	public float turnAbstractTiming;
    ...
    {
        while(timerAbstract*2 <= 1)
        {
			timerAbstract += Time.deltaTime;
